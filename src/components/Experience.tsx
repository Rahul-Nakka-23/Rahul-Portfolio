    ...
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2
            className={`text-3xl md:text-4xl font-bold mb-4 text-gray-900 dark:text-white transition-all duration-1000 ${
          ...
          <div
            className="w-20 h-1 bg-blue-600 dark:bg-blue-400 mx-auto mb-8 rounded transition-all duration-1000 delay-200"
            style={{ transform: isInView ? 'scaleX(1)' : 'scaleX(0)' }}
          ></div>
          <p
            className={`text-lg text-gray-600 dark:text-gray-400 transition-all duration-1000 delay-300 ${
              isInView ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
            }`}
          >
            Though I haven't yet embarked on my first professional role, I've
            cultivated a robust skill set in C, C++, Python programming, Java,
            HTML, CSS, JavaScript, MongoDB, ReactJS, Flutter and concepts like
            DSA and Machine Learning through intensive coursework, independent
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          {experienceData.map((item, index) => (
            <div
              key={item.id}
              className={`relative flex flex-col mb-12 md:mb-16 transition-all duration-1000 ${
                isInView
            ...
            >
              {/* Timeline dot */}
              <div className="absolute left-[-8px] top-0 w-4 h-4 rounded-full bg-blue-600 dark:bg-blue-400 border-4 border-white dark:border-gray-800"></div>

              {/* Content */}
              <div className="ml-8 pl-8 border-l border-blue-200 dark:border-blue-800">
