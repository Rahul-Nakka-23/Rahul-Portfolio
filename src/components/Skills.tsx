...
const Skills: React.FC = () => {
  ...
  const skillsData: Skill[] = [
    ...
    { name: 'React', level: 50, category: 'web' },

    // Tools
    { name: 'C Programming', level: 95, category: 'tools' },
    ...
    //core
    { name: 'Digital Circuits', level: 95, category: 'core' },
    { name: 'Signals and Systems', level: 80, category: 'core' },
    { name: 'Microprocessors and Microcontrollers', level: 80, category: 'core' },
    { name: 'Antenna and Wave Propagation', level: 70, category: 'core' },
